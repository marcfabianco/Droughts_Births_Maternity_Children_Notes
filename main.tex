...
\input{tables/droughts/categories_of_drought}
...
\input{tables/droughts/birthoutcomes_descriptive_drought} \\

\textbf{Panel B. Newborn and mother's hospitalizations} &&& && \\
\input{tables/droughts/hospitalizations_descriptive_drought} \\
...
\midrule
\input{tables_2410/01a_drought_maternal_outcomes_st} \\
...
\input{tables_2410/04a_drought_sinac_table_st} \\
\midrule
\textbf{Panel B. Base Model + Seasonal FE} & & & & & \\
\input{tables_2410/04b_drought_sinac_table_mumonth_st} \\
...
\toprule
\textbf{Panel A. Base Model} & & & & & \\
\input{tables_2410/02a_drought_hosp_table_st} \\

\textbf{Panel B. Base Model + Seasonal FE} & & & & & \\
\input{tables_2410/02b_drought_hosp_table_munmonth_st} \\
\bottomrule
\end{tabular}
...
\input{tables_2410/programs/11pg_drought_maternal_outcomes} \\
\midrule
\textbf{Panel B. Seguro Popular} & & & & & & \\
\input{tables_2410/programs/11sp_drought_maternal_outcomes} \\
\bottomrule
\end{tabular}
...
\toprule
\textbf{Panel A. Progresa} & & & &  \\
\input{tables_2410/programs/21PG_hosp_oucomes} \\
\midrule
\textbf{Panel B. Seguro Popular} & & & & \\
\input{tables_2410/programs/21SP_hosp_oucomes} \\
\bottomrule
\end{tabular}
\caption*{\footnotesize{Notes: All specifications include municipality FE, municipality-year FE, month-year FE, municipality-by-calendar month FE. $^* p<0.1, ^{**} p<0.05, ^{***} p<0.01$.}}
\end{table}
...
\toprule
\textbf{Panel A. Progresa} & & & &  \\
\input{tables_2410/programs/12pg_drought_maternal_outcomes} \\
\midrule
\textbf{Panel B. Seguro Popular} & & & & \\
\input{tables_2410/programs/12sp_drought_maternal_outcomes} \\
\bottomrule
\end{tabular}
\caption*{\footnotesize{Notes: All specifications include municipality FE, municipality-year FE, month-year FE, municipality-by-calendar month FE. $^* p<0.1, ^{**} p<0.05, ^{***} p<0.01$.}}
\end{table}
...
\toprule
\textbf{Panel A. Progresa} & & & &  \\
\input{tables_2410/programs/42PG_sinac_heterogeneity_st} \\
\midrule
\textbf{Panel B. Seguro Popular} & & & & \\
\input{tables_2410/programs/42SP_sinac_heterogeneity_st} \\
\bottomrule
\end{tabular}
\caption*{\footnotesize{Notes: All specifications include municipality FE, municipality-year FE, month-year FE, municipality-by-calendar month FE. $^* p<0.1, ^{**} p<0.05, ^{***} p<0.01$.}}
\end{table}
...
\toprule
\textbf{Panel A. Progresa} & &   \\
\input{tables_2410/programs/22PG_drought_maternal_outcomes} \\
\midrule
\textbf{Panel B. Seguro Popular} & &  \\
\input{tables_2410/programs/22SP_drought_maternal_outcomes} \\
\bottomrule
\end{tabular}
\caption*{\footnotesize{Notes: All specifications include municipality FE, municipality-year FE, month-year FE, municipality-by-calendar month FE. $^* p<0.1, ^{**} p<0.05, ^{***} p<0.01$.}}
\end{table}
